...
int main(void)
{
    ...
    while(1) //Run the code forever
    {
        ...
        for(delay=20000;delay>500;delay-=dec)   //The variable delay is the number of loop cycles between each toggle of the LED
            //It is starts from 30000 and is decremented after every successful switch press
        {
            ...
            if(delay==10000) dec=2000;
            if(delay==2000) dec=500;
